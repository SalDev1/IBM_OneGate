...
const connectDb = async () => {
    try {
       ...
       const conn = await mongoose.connect(`mongodb+srv://admin1234:admin1234@mern-cluster.sbdelpp.mongodb.net/merndb?retryWrites=true&w=majority&appName=mern-cluster`)
